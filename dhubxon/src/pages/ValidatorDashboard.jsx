...
import GenReq from '../components/SubscribeButtons/Genreq'; // Importing General Requests component
import HealthReq from '../components/SubscribeButtons/HealthReq'; // Importing Health Requests component

const ValidatorDashboard = () => {
    // State for managing sidebar open/close and selected component
    const [selectedComponent, setSelectedComponent] = useState(null);

    // Function to render General Requests component
    const renderGeneralRequests = () => {
        setSelectedComponent(<GenReq />);
    };

    // Function to render Health Requests component
